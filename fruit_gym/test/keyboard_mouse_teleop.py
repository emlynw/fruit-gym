...
def main():
    ...
    env = gym.make("PickMultiStrawbEnv", randomize_domain=True, cameras=cameras, include_priveleged_obs=True, reward_type="dense", ee_dof=4, width=camera_res, height=camera_res, gripper_pause=False)
