...
def main():
    ...
    env = gym.make("PickMultiStrawbEnv", randomize_domain=True,reward_type=reward_type, ee_dof=ee_dof, width=camera_res, height=camera_res, gripper_pause=False, face_left=False, cameras=cameras)
